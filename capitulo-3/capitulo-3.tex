...
\begin{defs}(Clasificador\abbr{ML}) Un algoritmo\abbr{ML} recibe un conjunto entrenamiento se compone de varios pares $(\boldsymbol{x},y)$ conocidos como muestras de entrenamiento, donde
\begin{itemize}
...
\begin{enumerate}
\item $y$ es un número del conjunto de reales. Este caso corresponde a un problema de regresión.
