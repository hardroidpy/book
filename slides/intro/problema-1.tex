...
\framesubtitle{Definición del Problema}
\begin{overprint}
\onslide<1> 
\begin{quote}
...
algoritmos para:
\begin{itemize}
\item Capturar movimientos de individuos en interacción con su entorno 
...
\end{spacing}
\begin{itemize}
\item Popularidad de \structure{aplicaciones móviles} de contexto en 
\begin{itemize}
...
Medio de interacción que representa el estado de la información física,
