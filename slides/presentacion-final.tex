...
\author{Alberto Giménez\\
Santiago Yegros}

\institute{Tutores: Ing. Joaquín Lima\\
Ing. Juan Talavera}

\date{Facultad Politécnica - \monthname, \the\year}
\makebeamertitle
\begin{frame}
...
\AtBeginSection[]
{
	...
	\end{frame} 
} \include{intro/problema-1}

\include{intro/alcance-1}

\include{propuesta/estado-har-1}

\include{propuesta/sistema-har-1}\include{propuesta/hardroid-1}\include{resultados/resultados-1}

\include{conclusion/conclusion}

\include{anexo/anexo}

\include{anexo/ecuaciones}\include{anexo/hardesing}
\end{document}
