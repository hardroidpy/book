...
\frametitle{Anexo 1}
\framesubtitle{Selección de atributo de división}
...
\column{0.3\textwidth}
	...
	\begin{itemize}
		...
		\item Calcular proporción de ganancia.
	\end{itemize}
...
Por lo tanto el mejor atributo de división es \textit{ESTADO}
...
Finalmente la división en el atributo ESTADO quedaría de la siguiente manera:
