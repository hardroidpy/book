...
Para validar y verificar el clasificador se realizaron dos tipos de pruebas, siguiendos los siguientes pasos:

\begin{itemize}[<+->]
	\item Creación de un conjunto de entrenamiento inicial del clasificador para \emph{HARDroid}.
	\item Evaluación del clasificador inicial en comparación con \emph{Sony Lifelog}.
	\item Generación de un nuevo conjunto entrenamiento colaborativo cuyo clasificador es comparado con el inicial.
\end{itemize}
...
\onslide<4> 
	\begin{table}[h]
		\begin{centering}
			...
			\end{tabular}
			\par\end{centering}
		\caption{Muestras etiquetadas procesadas en el conjunto de entrenamiento inicial}
	\end{table}
\end{overprint}
...
De manera a evaluar el rendimiento del clasificado se utilizan medidas y métricas de predicción:
...
El clasificador inicial es un árbol de decisión de tamaño de $677$ nodos, de los cuales $339$ son hojas. Las métricas de validación son:
\begin{itemize}
...
La matriz se resume con las siguientes métricas de evaluación:
\begin{itemize}
...
\framesubtitle{Verificación del Clasificador}
...
\resizebox{9cm}{!}{
	...
	\caption{Comparación de métricas de predicción}
\end{table}
...
Las métricas de evaluación del clasificador colaborativo:
\begin{itemize}
