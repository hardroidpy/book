...
\begin{itemize}[<+->]
	\item Creación de un conjunto entrenamiento inicial para el clasificador de \emph{HARDroid}.
	\item Evaluación del reconocedor \emph{HARDroid} en comparación con \emph{Sony Lifelog}.
	\item Generación de un nuevo conjunto entrenamiento colaborativo cuyo clasificador es evaluado.
\end{itemize}
...
\begin{itemize}
	...
	\item Instancias correctamente clasificadas ($C$).
	\item Instancias incorrectamente clasificadas ($I$).
...
\begin{itemize}
	\item Error medio absoluto ($E_{ma}$): promedio de errores absolutos.
	\item Raíz de Error cuadrático medio ($E_{rms}$): raíz del promedio de errores cuadráticos.
	\item Error absoluto relativo ($E_{ra}$): suma de errores absolutos relativo a la suma
	de errores absolutos respecto a la media.
	\item Raíz de Error cuadrático relativo ($E_{rrs}$): raíz de la suma de errores cuadráticos
	 relativo a la suma de errores cuadráticos respecto a la
	media.
\end{itemize}
...
%
\begin{frame}{Resultados}
\framesubtitle{Mejoras del Clasificador}
