...
\begin{itemize}
\item Aplicaciones cuyo medio de interacción es además el contexto.
\end{itemize}
...
\pause{}
\begin{itemize}
\item Tipos de contexto comunes en computación móvil son 
\begin{itemize}
\item la ubicación, 
\item la identidad, 
\item la actividad 
...
\setbeamercovered{transparent}
\begin{itemize}[<+->]
\item Proveer un módulo para el desarrollo de aplicaciones de contexto. 
