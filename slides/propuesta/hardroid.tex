...
\item Clasificador dinámico (\structure{DEX})
\end{itemize}

\pause{}
\item \textbf{ActivitySurvey}
\begin{itemize}
\item Aplicación de encuesta que depende del servicio.
...
\item mecanismos fáciles de integración.
\end{itemize}
\end{itemize}
...
\framesubtitle{HARDroid: Mecanismo de Integración}
\begin{center}
\includegraphics[width=0.5\columnwidth]{propuesta/graphics/archi_ipc}
\par\end{center}
\begin{block}{Nota}
Servicio y Aplicación disponibles en \structure{Google Play Store}
\end{block}
\end{frame}
%
\begin{frame}{HAR en Android}
