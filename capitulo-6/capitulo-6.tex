...
en la \secref{sec44:proceso-senales} para transformar datos sensoriales
...
automatizado por medio una herramienta construida en \emph{Java }para
este trabajo\emph{ }a partir de \emph{Clasificador C4.5} disponible
...
corregida en caso de una aseveración. 
...
la predicción de la aplicación \emph{Sony} \emph{Lifelog,} asumiendose
...
de evaluación para este nuevo clasificador fueron:
\begin{itemize}
