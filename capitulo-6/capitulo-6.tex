...
Como está constatado en capítulos anteriores el desarrollo de \emph{\abbr{HARDroid}
}se concretó completamente para la plataforma \emph{\abbr{Android}
...
corregida en caso de una aseveración. En la \figref{fig6:activity-survey}
