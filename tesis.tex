...
%\include{preambulo_0/simbolos}

\mainmatter  % inician los capitulos de la tesis

\include{preambulo_0/glosario}
...
\include{capitulo-4/capitulo-4} 	%Cap 4: Sistemas de Reconocimiento de Actividades
\include{capitulo-5/capitulo-5}		%Cap 5: HARDroid: Un Sistema Reconocedor Colaborativo
%Parte IV: Resultados
