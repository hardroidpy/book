...
Debido a la libertad de movilidad presente en la computación móvil
...
(\emph{\abbr{Wearable}}) cuando los sensores están sujetos o anexados
...
y sensores de profundidad (Ej. el sensor \emph{\abbr{Kinect}}). 
...
Los sensores de atuendo (comúnmente denominado\emph{ \abbr{Wearable}})
...
inalámbricos. Los teléfonos móviles inteligentes proveen a sus usuarios
...
En el capítulo \ref{chap:Aprendizaje-Automatico} se detalla la base
