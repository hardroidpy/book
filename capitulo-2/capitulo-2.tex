...
a todas partes los sensores haciendolos ubicuos, portables y con una
...
anexos a una vestimenta y sin cableríos.
...
\label{def2:harp}\newtheorem{defi}{Definición}\begin{defi}(Problema
\abbr{HAR}) Dado un conjunto $S=\{s_{0},...,s_{k-1}\}$ de $k$ series
de tiempo, cada una con una medida particular de cada atributo, y
definidas en el intervalo de tiempo $I=\left[t_{\alpha},t_{\omega}\right]$,
...
\label{def2:harp-rel}\newtheorem{defi}{Definición}\begin{defi}(Problema
\abbr{HAR} relajado) Dado (1) un conjunto $W=\{w_{0},...,w_{m-1}\}$
...
atributos medidos, y (2) un conjunto $A\text{=}\{a_{0},...,a_{n-1}\}$
...
con varios algoritmos efectivos sumarizados en la tabla \tabref{tab2:metodos-aprendizaje}.
