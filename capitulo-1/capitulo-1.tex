...
El reconocimiento de actividades humanas (\nomenclature{HAR}{Reconocimiento de Actividades Humanas, por sus siglas en inglés}HAR,
...
físicas. También, \emph{Apple} en su plataforma \nomenclature{iOS}{Es un sistema operativo móvil creado y desarrollado por Apple Inc.}\emph{iOS}
...
(\nomenclature{GPS}{Sistema de Geoposicionamiento Global, por sus siglas en inglés}GPS,
...
privativas (Ej. \emph{Google Play Services} API) (\nomenclature{API}{Interfaces de Programación de Aplicaciones, por sus siglas en inglés}API,
\emph{Application Programming Interface}), servicios de Internet (\nomenclature{SaaS}{Software como Servicio}SaaS,
...
automático por árboles de decisión (\nomenclature{DT}{Árboles de decisión, por sus siglas en inglés}DT,
