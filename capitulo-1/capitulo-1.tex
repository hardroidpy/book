...
Desarrollar sistemas inteligentes móviles (o aplicaciones contextuales)
...
físicas. Además, \emph{Apple} para en su plataform\emph{a \abbr{iOS}}
...
Las plataformas para aplicaciones móviles \emph{\abbr{Android}} e
\emph{\abbr{iOS}} proveen un ecosistema abierto para crear aplicaciones
