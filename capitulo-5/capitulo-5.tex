...
es la persistencia de datos por medio de una \abbr{API} que sigue
el principio \abbr{CRUD}, una forma de acceso parecida al de bases
de datos \abbr{SQL}. Los datos pueden ser persistidos en archivos
...
\begin{algorithm}
\caption{\label{alg5:reconocimiento}Procedimiento de detección de actividades
humanas}
...
preferencia de notificación de eventualidad de cada cliente. Ante
la eventualidad de un nuevo resultado de reconocimiento emitido por
el módulo de procesamiento se realiza un envío del resultado a los
...
generados por el \emph{software} \texttt{WEKA} \cite{Frank2016}.
...
Internet de manera segura un clasificador generado por \texttt{WEKA}.
...
por medio de WEKA se depende de la conexión a Internet y un recurso
publicado remotamente. El mecanismo de descarga detallado se describe
en el apéndice 2.
...
del clasificador basado en WEKA}
\end{figure}
...
el servicio \abbr{HAR} en \abbr{Android}. Permite obtener la perspectiva
...
Debido a que la aplicación móvil en \abbr{Android} debe ser fácil
