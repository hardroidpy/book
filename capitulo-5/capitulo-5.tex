...
\item \emph{Subscribirse} con cierta periodicidad a resultados de actividades
humanas detectados. 
...
subscribirse a eventos de detección actividades humanas:
\begin{itemize}
...
implementar la lógica de negocio y las funcionalidades esta interfaz.
...
que implementa el servidor \abbr{IPC} de \abbr{Android} para atender
las conexiones con los clientes. Además se encarga de registrar las
suscripciones y emitir los resultados de detección de acuerdo a las
...
calculo de vectores característicos y clasificación de actividad para
...
\end{itemize}
La ejecución del motor de reconocimiento empieza al iniciar servidor
...
Este módulo es el clasificador de actividades humanas a partir de
un vector característico y produce una estimación de la actividad
humana detectada. Posee dos implementaciones principales y complementarias
de acuerdo a los siguientes artefactos:
\begin{itemize}
...
descargado de Internet. El mecanismo detallado se describe en el apéndice
\ref{chapB:carga-dinamica}.
...
es bastante sencillo pero con los complementos necesarios que permiten
validar las funcionalidades de \abbr{HARDroid} y además encuestar
a usuarios reales durante una sesión de entrenamiento físico. En esta
sección se presenta la vista general de la aplicación explicada por
medio de los artefactos que describen las funcionalidades básicas
construidas. 

\subsection{Requerimientos Funcionales}

En esta sección se incluyen las especificaciones funcionales que describen
...
o parado dependiendo de la necesidad del usuario encuestado.
...
plataforma \abbr{Android} y su interacción. 
...
servicios utilitarios de implementación privada existentes como\emph{
...
obtenidos fueron satisfactorios teniendo en cuenta la integración
entre implementaciones de aplicación móvil y servidor utilitario separados
en procesos independientes. Los resultados experimentales confirmaron
la posibilidad de recolectar información en terreno a través de la
aplicación de encuesta y que luego esta información pueda ser validada,
limpiada y utilizada para mejorar el algoritmo de clasificación basado
en árboles de decisión de forma ininterrumpida. Se requiere experimentación
adicional para evaluar el servicio bajo condiciones realistas cuando
es instalado en diferentes teléfonos móviles y en conjunción con aplicaciones
distintas para su uso.
