...
y el servidor usualmente es una bases de datos relacional. En la \figref{fig5:cliente_servidor}
...
una interfaz denominada \emph{Android Interface Definition Language}
(\abbr{AIDL}) que forma parte del mecanismo \emph{IPC Binder} (ver
