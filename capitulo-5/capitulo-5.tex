...
en lenguaje \abbr{UML} donde los paquetes representan las aplicaciones
...
\abbr{Android}, en su entorno \abbr{DVM} correspondiente, y la comunicación
entre distintos procesos se lleva acabo por medio de una interfaz
\abbr{AIDL} y facilitado por el mecanismo \abbr{IPC} \emph{Binder}.
...
\end{itemize}
En la \figref{fig5:domain} se muestra el diagrama de clases con los
...
La interfaz del servicio se compone de una conjunto de llamadas para
...
servicio en la \figref{fig5:service}.
