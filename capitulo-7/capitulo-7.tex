...
\item Utilizar un reloj inteligente (\abbr{Smartwatches}) u otros accesorios
...
por explorar, como las técnicas de vectores de soporte (\abbr{SVM})
o redes neuronales (\abbr{ANN}), y explorar cual obtiene mejores
