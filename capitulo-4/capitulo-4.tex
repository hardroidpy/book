...
discretos de \emph{Fourier} utilizando algoritmos \abbr{FFT} con
...
Las métricas son aplicadas a la señal de aceleración procesada considerando
...
\tabref{tab4:metricas} se resumen las métricas utilizadas con su
