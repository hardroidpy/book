...
de sus usuarios (un sistema \abbr{Wearable}). Por lo tanto, un sistema
...
\abbr{ML}). De acuerdo al proceso definido en la sección \ref{sec262:proceso-har},
...
El proceso de extracción se traduce en vectores característicos (\emph{\abbr{feature vectors}})
...
\begin{itemize}
\item Simplicidad para utilizar la técnica de \emph{Decision Tree} (\abbr{DT}).
...
En la \figref{fig4:clasificador} se muestra una gráfico esquemático
adaptado al problema \abbr{HAR} del proceso de extracción de conocimiento
