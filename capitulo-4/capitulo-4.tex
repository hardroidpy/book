...
esta representado por $a_{x}$, $a_{y}$ y $a_{z}$. En la \figref{fig4:muestra-ac}
...
$w_{x}$, $w_{y}$ y $w_{z}$. En la \figref{fig4:axis-phone} se
...
En la \figref{fig4:gps} se muestra una aplicación que despliega el
...
\abbr{Android} con la aplicación \emph{SensorLog} \cite{GPStore2016s}. 

El protocolo de recolección consisten en alistar un grupo de personas
...
medio de la aplicación disponible para la plataforma \abbr{Android}
demostrada en la \figref{fig4:sensor-log}. 
...
simple que permite elegir los sensores (Ej. \abbr{GPS}, acelerómetro,
...
En la \tabref{tab4:ex-signal} se muestra un ejemplo de las posibles
