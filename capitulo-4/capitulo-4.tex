...
de sus usuarios (\abbr{Wearables}). Por lo tanto, un sistema que
...
\begin{figure}[!tbph]
\centering{}\includegraphics[width=1\columnwidth,width=1\linewidth]{capitulo-4/graphics/diagrama_4_1}\caption[Componentes HAR]{\label{fig4:componentes-har}Componentes de los sistemas \abbr{HAR}}
\end{figure}
...
diseñada para el caso, Ej. Utilizando un teléfono \abbr{Android}
...
disponible para la plataforma \abbr{Android} es mostrada en la \figref{fig4:sensor-log}. 
...
se muestra una gráfico esquemático adaptado al problema \abbr{HAR}
...
el capítulo \ref{chap:Aprendizaje-Automatico} en base a la matriz
de confusión y las métricas de exactitud, precisión, exhaustividad
y valor \emph{F}.
...
enfoque de arboles de decisión descrito en el capitulo \ref{chap:Aprendizaje-Automatico}.
