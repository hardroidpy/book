...
Estos vectores característicos con información relevante son obtenidos
por cálculos realizados a partir de las ventanas $w_{i}$ con actividades
en el dominio del tiempo como también en el dominio de frecuencia.
Los métodos de cálculo son de tipos estadísticos y estructurales \cite{LaraLabrador2013}
y se resumen en la siguiente \tabref{tab4:metricas} de métricas.
